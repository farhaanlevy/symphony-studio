...
hooks:
  after_create: |
    git clone --depth 1 --branch release/v0.2.0-buildweek-preview.1 https://github.com/farhaanlevy/symphony-studio.git .
...
agent:
  ...
  max_turns: 20
codex:
  command: codex --config shell_environment_policy.inherit=all --config 'model="gpt-5.6-sol"' --config model_reasoning_effort=ultra app-server
